...
@section('content')
    <div class="row g-3 mb-4 align-items-center justify-content-between">
        <div class="col-auto">
            <h1 class="app-page-title mb-0">Departamentos</h1>
        </div>
        <div class="col-auto">
                ...
                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                    ...
                    <div class="modal fade in" id="agregarModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            ...
                            <form class="settings-form" action="{{route('agregar_departamentos')}}" method="POST">
                                @method('POST')
                                @csrf
                                <div class="modal-body"> 
                                    <div class="mb-3">
                                        <label for="setting-input-2" class="form-label">Nombre departamento</label>
                                        <input type="text" name="nombre" class="form-control" id="setting-input-2" required>
                                    </div>  
                                </div>
                                ...
                                <table class="table app-table-hover mb-0 text-left">
                                    ...
                                    <tbody> <?php $i=1; ?>
                                        @foreach($departamentos as $departamento)
                                            <tr>
                                                <td class="cell">{{$i}}</td>
                                                <td class="cell"><span class="truncate">{{$departamento->nombre}}</span></td>
                                                <td class="cell"><span class="badge bg-success">Activo</span></td>
                                                <td class="cell"><span>17 Oct</span><span class="note">2:16 PM</span></td>
                                                <td class="cell"><a class="btn-sm app-btn-secondary" href="{{route('editar_departamentos_view', $departamento->id)}}">Editar <i class="bi bi-pencil"></i></a></td>
                                            </tr>
                                            <?php $i++; ?>
                                        @endforeach
                                    </tbody>
