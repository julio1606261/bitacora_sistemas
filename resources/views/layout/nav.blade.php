		        ...
		        <div class="app-header-content"> 
		            ...
		            <div class="app-utilities col-auto">
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img src="{{asset('/images/user.png')}}" alt="Perfil de usuario"></a>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="/"><span class="logo-text">Bitácora sistemas</span></a>
				    ...
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item has-submenu">
					        ...
					        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="{{route('bitacora')}}">Bitácora de eventos</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="{{route('reportes')}}">Reportes</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    ...
					    <li class="nav-item has-submenu">
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="{{route('departamentos')}}">Departamentos</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="{{route('usuarios')}}">Usuarios</a></li>
						    ...
						    <li class="nav-item" style="">
						        ...
						        <a class="nav-link" href="{{route('logout')}}">
							        <span class="nav-icon">
                                        ...
                                        {{-- <img src="{{asset('images/user.png')}}"  class="bi bi-file-person" alt="My Happy SVG"/> --}}
							        </span>
